				...
				<header class="navbar navbar-default navbar-static-top">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">
							<h1>HRMS</h1><!-- <img src="resources/STANDARD/assets/images/logo.png" alt="Clip-Two"/> -->
						</a>
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-right">
											...
											<ul>
													...
													<a href="javascript:;" class="unread">
														<div class="clearfix">
															<div class="thread-image">
																<img src="resources/STANDARD/assets/images/avatar-2.jpg" alt="">
															</div>
												...
												<li>
													<a href="javascript:;" class="unread">
														<div class="clearfix">
															<div class="thread-image">
																<img src="resources/STANDARD/assets/images/avatar-3.jpg" alt="">
															</div>
															<div class="thread-content">
												...
												<li>
													<a href="javascript:;">
														<div class="clearfix">
															<div class="thread-image">
																<img src="resources/STANDARD/assets/images/avatar-5.jpg" alt="">
															</div>
															<div class="thread-content">
										...
										<div class="drop-down-wrapper ps-container">
											<div class="list-group no-margin">
												<a class="media list-group-item" href="">
													<img class="img-circle" alt="..." src="resources/STANDARD/assets/images/avatar-1.jpg">
							...
							<li class="dropdown current-user">
								<a href class="dropdown-toggle" data-toggle="dropdown">
									<img src="resources/STANDARD/assets/images/avatar-1.jpg" alt="Peter"> <span class="username">Peter <i class="ti-angle-down"></i></i></span>
								</a>
