		...
		<div class="col-sm-4">
			<div class="panel panel-white no-radius text-center">
				<div class="panel-body">
					...
					<p class="text-small">To add users, you need to be signed in as
						the super user.</p>
		...
		<div class="col-sm-4">
			<div class="panel panel-white no-radius text-center">
				<div class="panel-body">
					...
					<p class="text-small">The Manage Orders tool provides a view of
						all your orders.</p>
					<p class="cl-effect-1">
						<a href> view more </a>
					</p>
		...
		<div class="col-sm-4">
			<div class="panel panel-white no-radius text-center">
				<div class="panel-body">
					...
					<p class="text-small">Store, modify, and extract information
							...
							<ul class="panel-heading-tabs border-light">
								<li>
									<div class="pull-right">
										<div class="btn-group">
											<a class="padding-10" data-toggle="dropdown"> <i
												class="ti-more-alt "></i>
											</a>
	...
	<div class="row">
		<div class="col-sm-8">
			<div class="panel panel-white no-radius">
				<div class="panel-body">
					<div
						class="partition-light-grey padding-15 text-center margin-bottom-20">
			...
			<div class="panel panel-white no-radius">
				...
				<div class="panel-body">
					<div class="text-center">
						<span class="mini-pie">
							<canvas id="chart3" class="full-width"></canvas> <span>450</span>
						</span> <span class="inline text-large no-wrap">Acquisition</span>
					</div>
					...
					<div class="tabbable no-margin no-padding">
						<ul class="nav nav-tabs" id="myTab">
							<li class="active padding-top-5 padding-left-5"><a
								data-toggle="tab" href="#users_followers"> Followers </a></li>
							<li class="padding-top-5"><a data-toggle="tab"
								href="#users_following"> Following </a></li>
						</ul>
						<div class="tab-content">
							<div id="users_followers"
										...
										<tbody>
											<tr>
												<td class="center"><img alt="image" class="img-circle"
													src="resources/STANDARD/assets/images/avatar-1-small.jpg"></td>
												<td><span class="text-small block text-light">UI
														Designer</span><span>Peter Clark</span></td>
												<td class="center">
											...
											<tr>
												<td class="center"><img alt="image" class="img-circle"
													src="resources/STANDARD/assets/images/avatar-2-small.jpg"></td>
												<td><span class="text-small block text-light">Content
														Designer</span><span>Nicole Bell</span></td>
												<td class="center">
													<div class="cl-effect-13">
														<a href> view more </a>
													</div>
											...
											<tr>
												<td class="center"><img alt="image" class="img-circle"
													src="resources/STANDARD/assets/images/avatar-3-small.jpg"></td>
											...
											<tr>
												<td class="center"><img alt="image" class="img-circle"
													src="resources/STANDARD/assets/images/avatar-5-small.jpg"></td>
											...
											<tr>
												<td class="center"><img alt="image" class="img-circle"
													src="resources/STANDARD/assets/images/avatar-4-small.jpg"></td>
				...
				<div class="col-md-12">
					<div class="panel panel-white no-radius">
						<div class="panel-body padding-20 text-center">
							...
							<span class="text-white-transparent"><i
								class="fa fa-clock-o"></i> 1 hour ago</span>
						</div>
					</div>
				</div>
				<div class="col-md-12">
					...
					<ul class="timeline-xs margin-top-15 margin-bottom-15">
						...
						<li class="timeline-item info">
							<div class="margin-left-15">
								...
								<p>
									Contacted <a class="text-info" href> Microsoft </a> for license
									upgrades.
								</p>
							</div>
						</li>
						...
						<ol class="discussion">
							...
							<li class="self">
								<div class="message">
									...
									<div class="message-avatar">
										<img src="resources/STANDARD/assets/images/avatar-1.jpg"
											alt="">
									</div>
								</div>
								<div class="message">
							...
							<li class="other">
								<div class="message">
									...
									<div class="message-avatar">
										<img src="resources/STANDARD/assets/images/avatar-2.jpg"
											alt="">
									</div>
								</div>
							</li>
							...
							<li class="other">
								<div class="message">
									<div class="message-name">Nicole Bell</div>
									<div class="message-text">What do you think about my new
										Dashboard?</div>
									<div class="message-avatar">
										<img src="resources/STANDARD/assets/images/avatar-2.jpg"
											alt="">
							...
							<li class="self">
								...
								<div class="message">
									<div class="message-name">Peter Clark</div>
									<div class="message-text">literally we get the question
										daily</div>
									<div class="message-avatar">
										<img src="resources/STANDARD/assets/images/avatar-1.jpg"
											alt="">
							...
							<li class="other">
								<div class="message">
									<div class="message-name">Nicole Bell</div>
									<div class="message-text">I know. I, however, am not a
										nerd, and want to know</div>
									<div class="message-avatar">
										<img src="resources/STANDARD/assets/images/avatar-2.jpg"
											alt="">
									</div>
