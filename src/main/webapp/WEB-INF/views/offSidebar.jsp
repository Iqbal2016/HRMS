							...
							<ul class="media-list">
								<li class="media"><a data-toggle-class="chat-open"
									data-toggle-target="#users" href="#"> <i
										...
										src="resources/STANDARD/assets/images/avatar-2.jpg"
										class="media-object">
								...
								<li class="media"><a data-toggle-class="chat-open"
									data-toggle-target="#users" href="#">
										...
										src="resources/STANDARD/assets/images/avatar-3.jpg"
										class="media-object">
										<div class="media-body">
								...
								<li class="media"><a data-toggle-class="chat-open"
									data-toggle-target="#users" href="#"> <i
										class="fa fa-circle status-online"></i> <img alt="..."
										src="resources/STANDARD/assets/images/avatar-4.jpg"
										class="media-object">
										<div class="media-body">
								...
								<li class="media"><a data-toggle-class="chat-open"
									data-toggle-target="#users" href="#"> <i
										class="fa fa-circle status-online"></i> <img alt="..."
										src="resources/STANDARD/assets/images/avatar-5.jpg"
										class="media-object">
										<div class="media-body">
							...
							<ul class="media-list">
								<li class="media"><a data-toggle-class="chat-open"
									data-toggle-target="#users" href="#"> <img alt="..."
										src="resources/STANDARD/assets/images/avatar-6.jpg"
										class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Nicole Bell</h4>
											<span> Content Designer </span>
								...
								<li class="media"><a data-toggle-class="chat-open"
									data-toggle-target="#users" href="#">
										...
										src="resources/STANDARD/assets/images/avatar-7.jpg"
										class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Steven Thompson</h4>
											<span> Visual Designer </span>
								...
								<li class="media"><a data-toggle-class="chat-open"
									data-toggle-target="#users" href="#"> <img alt="..."
										src="resources/STANDARD/assets/images/avatar-8.jpg"
										class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Ella Patterson</h4>
											<span> Web Editor </span>
								...
								<li class="media"><a data-toggle-class="chat-open"
									data-toggle-target="#users" href="#"> <img alt="..."
										src="resources/STANDARD/assets/images/avatar-9.jpg"
										class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Kenneth Ross</h4>
											<span> Senior Designer </span>
								...
								<li class="media"><a data-toggle-class="chat-open"
									data-toggle-target="#users" href="#"> <img alt="..."
										src="resources/STANDARD/assets/images/avatar-10.jpg"
										class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Ella Patterson</h4>
											<span> Web Editor </span>
